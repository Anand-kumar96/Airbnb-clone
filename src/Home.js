  ...
  return (
    <div className='home'>
        ...
        <Card
            ...
            description="One of our goals is to make guests enjoy themselves as much as possible and give them just that little bit more that is not possible elsewhere."
            price="₹22,422/night"
        />
        </div>
    </div>
